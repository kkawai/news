...
public class CircularImageView extends ImageView {
	...
	private void init(Context context, AttributeSet attrs, int defStyle)
	{
		...
		if(hasBorder) {
			...
			setBorderWidth(attributes.getDimensionPixelOffset(R.styleable.CircularImageView_border_width2, defaultBorderSize));
			setBorderColor(attributes.getColor(R.styleable.CircularImageView_border_color2, Color.WHITE));
		}
