...
import com.initech.news.util.ScreenUtil;
 ...
 */
public class DraggablePanel extends FrameLayout implements DraggableLockCallback {
    ...
    public void initializeView() {
        ...
        draggableView.setBackshadowView(backshadowView);
        initialised = true;
    }
