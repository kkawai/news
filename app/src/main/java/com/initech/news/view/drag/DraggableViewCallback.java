...
class DraggableViewCallback extends ViewDragHelper.Callback {
   ...
   private static final float X_MIN_VELOCITY = 800;
   ...
   public void onViewReleased(View releasedChild, float xVel, float yVel) {
      MLog.i(TAG, "DraggableViewCallback.onViewReleased()");
   ...
   public void onViewDragStateChanged(final int state) {
      draggableView.setIsDragging(state == ViewDragHelper.STATE_DRAGGING);
      MLog.i(TAG, "DraggableViewCallback.onViewDragStateChanged() " + (state == ViewDragHelper.STATE_DRAGGING ? "dragging" : "dragging stopped"));
   }

   @Override
   public void onViewCaptured(View capturedChild, int activePointerId) {
      super.onViewCaptured(capturedChild, activePointerId);
      MLog.i(TAG, "DraggableViewCallback.onViewCaptured()");
   }
