...
public class ViewDragHelper {
    ...
    public boolean smoothSlideViewTo(View child, int finalLeft, int finalTop) {
        return smoothSlideViewTo(child,finalLeft,finalTop,true);
    }

    public boolean smoothSlideViewTo(View child, int finalLeft, int finalTop, final boolean isAnimate) {
        mCapturedView = child;
        mActivePointerId = INVALID_POINTER;

        boolean continueSliding = forceSettleCapturedViewAt(finalLeft, finalTop, 0, 0, isAnimate);
    ...
    public boolean settleCapturedViewAt(int finalLeft, int finalTop) {
        ...
        return forceSettleCapturedViewAt(finalLeft, finalTop,
                ...
                (int) VelocityTrackerCompat.getYVelocity(mVelocityTracker, mActivePointerId),true);
    }
     ...
     * @return true if animation should continue through {@link #continueSettling(boolean)} calls
     */
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel, final boolean isAnimate) {
